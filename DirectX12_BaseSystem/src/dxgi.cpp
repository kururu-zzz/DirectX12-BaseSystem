...
namespace dxgi
{
	...
	std::shared_ptr<IDXGISwapChain> CreateSwapChain(HWND hWnd, ID3D12Device * device, ID3D12CommandQueue * commandQueue, DXGI_SWAP_CHAIN_DESC* swapChainDesc)
	{
